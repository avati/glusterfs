...
ssize_t
gf_xdr_serialize_cli_defrag_vol_rsp2 (struct iovec outmsg, void *rsp)
{
        return xdr_serialize_generic (outmsg, (void *)rsp,
                                      (xdrproc_t)xdr_gf1_cli_defrag_vol_rsp2);

}

ssize_t
gf_xdr_to_cli_defrag_vol_rsp2 (struct iovec inmsg, void *args)
{
        return xdr_to_generic (inmsg, (void *)args,
                               (xdrproc_t)xdr_gf1_cli_defrag_vol_rsp2);
}
