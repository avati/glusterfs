...
int
glusterd_defrag_status_get2 (glusterd_volinfo_t *volinfo,
                            gf1_cli_defrag_vol_rsp2 *rsp)
{
        if (!volinfo)
                goto out;
...
int
glusterd_handle_defrag_volume2 (rpcsvc_request_t *req)
{
        int32_t                 ret           = -1;
        ...
        case GF_DEFRAG_CMD_STATUS:
                ret = glusterd_defrag_status_get2 (volinfo, &rsp);
                break;
        default:
                break;
        }
...
out:
        ...
        ret = glusterd_submit_reply (req, &rsp, NULL, 0, NULL,
                                     gf_xdr_serialize_cli_defrag_vol_rsp2);
        if (cli_req.volname)
